...
$tab=gets('tab');
$tab=in_array($tab,Array('label','stopname'))?$tab:"label";
...
<div class="tviewx"><div style="margin:15px 0 0 0;"><span style="font:bold 20px 'Segoe UI', Verdana, Tahoma, sans-serif"><?=$ct_title?></span></div></div>
...
<div id="ct_box_wrapper">
	...
	<div id="prefbox" style="width:100%">
		<?php
			if($tab=='label'){
			require_once(VWDIR.'r_label.php');
			} else {
			require_once(VWDIR.'r_main.php');
			}
		?>
	</div><br/><br/><br/>
	<!-- ========= END OF CONTENT ========= -->
