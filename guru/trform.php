...
<form name="regform" id="regform" enctype="multipart/form-data" action="trreq.php" method="post" style="margin:0;padding:0;display:">
<div style="position:relative;width:250px;height:40px">
<button id="fakebtn" class="btn" style="position:absolute;top:0px;left:0px">
	<div style="background:url('<?=IMGR?>bi_photo.png') no-repeat;padding-left:16px">Ambil foto</div>
</button>
...
<div style="<?=SFONT12?>width:200px;position:absolute;top:4px;left:100px;color:#999">Max: 2 MB</div>
</div>
</form>
