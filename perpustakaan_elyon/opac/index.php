...
function photof($d=0,$f='$',$t=''){
	$photodir='../photo/';
	if(empty($d))$d=0;
	echo '<div style="position:relative;width:100px;height:155px;float:left;margin:10px 20px 15px 20px">';
	...
	if($d!=0 && file_exists($photodir.$f.'.php')){
		$sz='width="100px"';
		echo '<img style="float:left" src="'.$photodir.$f.'.php?id='.$d.'" '.$sz.' style="display:"/>';
		
	} else {
		echo '<div style="border-left:8px solid #666;width:90px;height:100px;background:#f0f0ff;font:11px Verdana;text-align:center;padding:15px 6px"><b>'.$t.'</b></div>';
	}
	echo '</div></div>';
}
