...
$replid=gpost('id');
$cid=$replid;
$t=mysql_query("SELECT * FROM psb_calonsiswa WHERE replid='$replid' LIMIT 0,1");
...
?>
<table cellspacing="0" cellpadding="0" width="100%"><tr><td id="fformt" align="center" style="padding-top:60px">
<div id="fformbox" class="fformbox" style="width:<?=($fwidth+20)?>px;overflow:hidden">
	...
	<div style="float:left">
		...
		<div class="xrowl2">
			<div class="xlbl" style="width:200px">Proses penerimaan</div><div class="xlbl">: <?=$proses['proses']?></div>
		</div>	
		<div class="xrowl2">
			<div class="xlbl" style="width:200px">Kelompok calon siswa</div><div class="xlbl">: <?=$kelompok['kelompok']?></div>
		</div>
		<div class="xrowl2">
			<div class="xlbl" style="width:200px">No. pendaftaran</div><div class="xlbl">: <?=$r['nopendaftaran']?></div>
		</div>
		<div class="xrowl2">
			<div class="xlbl" style="width:200px">Status</div><div class="xlbl">: <?=($r['status']==0?'Belum diterima':'<span style="color:#00a000"><b>Diterima</b></span>')?></div>
		</div>
	</div>
	<div style="float:right">
		<input type="button" class="btn" style="float:right;margin-left:4px" onclick="close_fform()" value="Tutup"/>
		<button class="btn" style="display:none;float:right" onclick="pendataan_view_print('<?=$r['replid']?>')"><div class="bi_pri">Cetak</div></button>
	</div>
	</div>
	...
	<div style="float:left;width:100%;margin-bottom:20px">
		...
		<?php
			$t=mysql_query("SELECT * FROM psb_calonsiswa_saudara WHERE calonsiswa='$cid' ORDER BY replid");
