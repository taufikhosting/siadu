...
?>
<table cellspacing="0" cellpadding="0" width="100%"><tr><td id="fformt" align="center" style="padding-top:50px">
<div id="fformbox" class="fformbox" style="width:<?=($fwidth+20)?>px;overflow:hidden">
	...
	<div style="float:right">
		<input type="button" class="btn" style="float:right;margin-left:4px" onclick="close_fform3()" value="Tutup"/>
		<!--button class="btn" style="float:right" onclick="pendataan_view_print('<?=$r['replid']?>')"><div class="bi_pri">Cetak</div></button-->
	</div>
	</div>
