...
// Form Title
if($opt=='af') $mtitle="Add new ".$fname."'s family";
else if($opt=='uf') $mtitle="Edit ".$fname."'s family data";
else $mtitle="Delete ".$fname."'s family data";
// Function Module 
$fmod="pf_family";
// db Table
$dbtable="emp_family";
...
if($opt=='a'||$opt=='u'||$opt=='d'||$opt=='rf'){
	...
	<div class="fformbox" style="width:<?=($fwidth+2)?>px;overflow:hidden">
		...
		<?php if($opt=='af' || $opt=='uf'){ $okbtn = ($opt=='af')?"Save":"OK"; $gd='true';
			// Add or Edit form ?>
			<tr><td>Relatives:</td><td><?=iSelect('family',$mstr_family,'',"float:left")?>
				<?=iAddMstrx('family','family relation','family relation')?></td></tr>
			<tr><td>Name:</td><td><?=iText('name',$r['name'],$iTextFw)?></td></tr>
			<tr valign="top"><td>Address:</td><td><?=iTextarea('address',$r['address'],$iTextFw,3)?></td></tr>
			<tr><td>Education:</td><td><?=iText('education',$r['education'],$iTextFw)?></td></tr>
			<tr><td>Birth place:</td><td><?=iText('birthplace',$r['birthplace'],$iTextFw)?></td></tr>
			<tr><td>Birth date:</td><td><?=inputDate('birthdate',$r['birthdate'])?></td></tr>
			<tr><td>Occupation:</td><td><?=iText('job',$r['job'],$iTextFw)?></td></tr>
