...
if($opt=='a'||$opt=='u'||$opt=='d'||$opt=='up'||$opt=='dn'){
	...
	<div class="fformbox" style="width:<?=($fwidth+20)?>px">
		...
		<?php } else if($opt=='df'){ $okbtn = "Yes"; $nobtn="   No   "; $gd='false';
			// Delete form ?>
			<tr><td><p class="line150">Are you sure you want to delete "<b><?=$r['name']?></b>"? All employee who had marital status "<?=$r['name']?>" will set to "Single".</p></td></tr>
		<?php }?>
			</table>
