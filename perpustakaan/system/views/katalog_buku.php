...
$xtable->btnbar_begin();
	...
	if($SOUF==0){
		...
		echo '<button class="btn" title="Tambah koleksi baru." style="float:left;margin-right:4px" onclick="katalog_buku_form(\'af\')"><div class="bi_add">Koleksi</div></button>';
...
hiddenval('opf','buk');
	$terbitan='';
	if($rk['penerbit']!=0)$terbitan=penerbit_name($rk['penerbit']);
	if($rk['kota']!=''){
...
<td width="400px">
	<table class="stable" cellspacing="0" cellpadding="0">
		...
		<tr height="24px"><td width="140px">Callnumber:</td><td><?=$rk['callnumber']?></td></tr>
		...
		<tr height="24px"><td width="140px">Terbitan:</td><td><?=$terbitan?></td></tr>
...
<td align="">
	<table class="stable" cellspacing="0" cellpadding="0">
		...
		<tr height="24px"><td width="140px">Dimensi:</td><td><?=$rk['dimensi'];?></td></tr>
...
<div class="tbltopmbar" style="float:left;margin-top:10px;margin-bottom:10px">
<div class="sfont"><b>Daftar koleksi :</b></div>
</div>
