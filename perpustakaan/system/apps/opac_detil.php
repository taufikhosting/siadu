...
$xform=new xform($fmod);
	...
	$judul=$r['judul'];	
	$b=explode("`",$judul);
	$c='<span style="font-size:20px">'.$b[0].'</span>'.($b[1]==''?"":"<br/>(".$b[1].")");
	$judul=stripslashes($c);
	...
	<tr><td>
		...
		<tr valign="top" style="height:110px">
			...
			<td style="padding-left:10px">
				<div class="sfont" style="color:#000;font-size:14px;color:#444;margin-bottom:6px"><?=$judul?></div>
				<?php if($r['npengarang']!=''){ ?>
