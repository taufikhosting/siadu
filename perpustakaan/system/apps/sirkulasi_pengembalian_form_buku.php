...
if($opt=='a'){
	...
	if($data!=""){
		...
		for($i=0;$i<$n;$i++){
			$cid=$did[$i];
			$q&=dbQSql("INSERT INTO pus_tpjm SET peminjaman='$cid',ssid='$ssid'");
		}
	}
}
	...
	echo '<tr><td><div id="box_sirkulasi_pengembalian_form_buku_list">';
		require_once(APPDIR.'sirkulasi_pengembalian_form_buku_list_get.php');
	echo '</div></td></tr>';
