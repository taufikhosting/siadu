...
$xform=new xform($fmod);
	...
	$db->field("pus_katalog:replid,judul,callnumber,penerjemah,editor,tahunterbit,kota,isbn,issn,seri,volume,edisi","pus_pengarang:nama as npengarang","pus_klasifikasi:kode,nama as nklas","pus_bahasa:nama as nbahasa","pus_jenisbuku:nama as njenis");
