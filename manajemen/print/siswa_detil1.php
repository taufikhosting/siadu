...
?>
	<table cellspacing="10px" cellpadding="0" width="100%" height="100%"><tr><td>
	<div style="cursor:default;text-align:left;color:<?=CDARK?>;font:24px <?=SFONTL?>;float:left;width:100%;margin-bottom:20px">
		<h3>Data Siswa</h3>
	</div>
	<div style="float:left;width:100%;padding-bottom:10px;border-bottom:1px solid #000;margin-bottom:10px;">
	<div style="float:left;width:100%">
		<div class="xrowl">
			<div class="xlbl" style="border-bottom:1px solid #000;width:100%;margin-left:-4px;margin-bottom:10px;padding-left:4px;padding-bottom:2px"><span style="color:#000;font:18px <?=SFONTL?>"><b><?=strtoupper($r['nama'])?></b></span></div>
		</div>
	...
	<div style="float:left;width:100%;padding-bottom:10px;margin-bottom:10px">
	<div style="float:left;width:100%;margin-bottom:20px">
	<div style="float:left">
		<div class="xrowl2" style="float:left;margin-bottom:10px"><div class="xlbl"><b>Data Pribadi Siswa:</b></div></div><br />
		<div class="xrowl2"><div class="xlbl" style="width:200px"></div>
		<div class="xlbl">Nama Lengkap : <?=$r['nama']?></div></div>
		<div class="xrowl2"><div class="xlbl" style="width:200px"></div>
        <div class="xlbl">Jenis kelamin: <?=$jkelamin[$r['kelamin']]?></div></div>
		...
		<div class="xrowl2" style="float:left;margin-bottom:10px;margin-top:20px"><div class="xlbl"><b>Kesehatan Siswa:</b></div></div>
		<div class="xrowl2"><div class="xlbl" style="width:200px">Golongan Darah</div><div class="xlbl">: <?=$r['darah']?></div></div>
		<div class="xrowl2"><div class="xlbl" style="width:200px">Penyakit yang pernah diderita</div><div class="xlbl">: <?=$r['kesehatan']?></div></div>
		<div class="xrowl2"><div class="xlbl" style="width:200px">Alergi terhadap</div><div class="xlbl">: <?=$r['ketkesehatan']?></div></div>
	</div>
	<div style="float:right">
		<div style="width:140px;margin-right:30px;margin-top:20px">
