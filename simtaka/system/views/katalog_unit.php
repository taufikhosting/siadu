...
// Page sort and order
$po=$xtable->pageorder_sql('kode','barkode','kondisi');
$t=mysql_query($sql.$po);

$xtable->btnbar_f('b-Grup barang',
	'<button class="btn" onclick="katalog_form(\'uf\',\''.$rk['replid'].'\')"><div class="bi_edit">Edit informasi barang</div></button>',
	'add');
