...
<form name="regform" id="regform" enctype="multipart/form-data" action="fureq.php" method="post" style="margin:0;padding:0;display:">
<div style="position:relative;width:250px;height:40px">
<button id="fakebtn" class="btn" style="position:absolute;top:0px;left:0px">
	<div style="background:url('<?=IMGR?>bi_file.png') no-repeat;padding-left:16px">Pilih file</div>
</button>
